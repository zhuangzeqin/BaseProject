package baseproject.demo.zzq.cn.eeepay.com.baseproject.view.dialog;
...
public class DialogUtil {
    ...
    public static void goToSettingPermission(Context context){
		...
		mCustomDialog.setPositiveButton(context.getString(R.string.permission_setting), new View.OnClickListener() {

			@Override
			public void onClick(View v) {

			}
		}).setNegativeButton(context.getString(R.string.permission_cancel), new View.OnClickListener() {
			@Override
			public void onClick(View v) {
			}
		}).show();
