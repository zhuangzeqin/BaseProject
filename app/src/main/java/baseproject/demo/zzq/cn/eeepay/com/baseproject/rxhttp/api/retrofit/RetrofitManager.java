...
import baseproject.demo.zzq.cn.eeepay.com.baseproject.constant.UrlConfig;
import baseproject.demo.zzq.cn.eeepay.com.baseproject.rxhttp.api.api.Api;
import baseproject.demo.zzq.cn.eeepay.com.baseproject.rxhttp.api.util.JsonUtil;
...
//       builder.addInterceptor(mHeader)
     ...
     * Log 日志拦截器
     */
    final okhttp3.logging.HttpLoggingInterceptor interceptor = new okhttp3.logging.HttpLoggingInterceptor(new HttpLoggingInterceptor.Logger() {
